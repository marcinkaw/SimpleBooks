...
"""
Taken from https://github.com/sq6jnx/pyliczba
"""
...
NASTKI = [u("dziesięć"), u("jedenaście"), u("dwanaście"), u("trzynaście"),
          u("czternaście"), u("piętnaście"), u("szesnaście"),
...
def cosslownie(liczba):
    """Słownie "ileś cosiów"

    liczba - int
    cos - tablica przypadków [coś, cosie, cosiów]"""

    return lslownie(liczba) + u(" ")
...
def kwotaslownie(liczba, fmt=0):
    ...
    if fmt != 0:
        ...
        groszslownie = u("%02d/100") % lgroszy
    return cosslownie(lzlotych) + u(" i ") + groszslownie